...
test('zápis musí zachovat typ podpory', () => assert.throws(() => validateRecordOutput({ consultationType: 'Depistáž', recordText: 'Dostatečně dlouhý text zápisu.' }, { consultationType: 'Doprovod klienta' }), /změnila/));
